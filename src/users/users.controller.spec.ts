...
describe('UsersController', () => {
  ...
  // In controller testing, we cannot test functionalities of decorators
  // So in find method, we cannot validate if it is a get request or the email is of type string
